...
public class TreeMaker implements JCTree.Factory {
    ...
    public JCExpression NewMap(List<JCExpression> entries) {
        ...
        JCFieldAccess of = new JCFieldAccess(map, names.fromString("ofEntries"), null);

        JCMethodInvocation invocation = new JCMethodInvocation(List.nil(), of, entries);
        invocation.pos = pos;
